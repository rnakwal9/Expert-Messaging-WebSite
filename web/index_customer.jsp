<%--
    ...
    Created on : Jun 5, 2020, 6:41:46 PM
    Author     : HP
--%>
        ...
        <div class="row">
            ...
            <div class="col md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active content-section-c" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Answered Questions</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link content-section-c" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Unanswered Questions</a>
                  </li>
                  <li class="nav-item">
